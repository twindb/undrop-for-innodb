undrop-for-innodb Omnibus project
=================================
...
```shell
$ bin/omnibus clean undrop-for-innodb
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/undrop-for-innodb`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean undrop-for-innodb --purge
```
...
[vagrant@ubuntu...] $ cd undrop-for-innodb   # or 'cd undrop-for-innodb/omnibus' if your omnibus project is embedded in your main project
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ bin/omnibus build undrop-for-innodb
```
